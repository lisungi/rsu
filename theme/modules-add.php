                          ...
                          <tr>
                            ...
                            <td>
                                  <label class="custom-control custom-checkbox px-2 m-0">
                                    <input type="checkbox" class="custom-control-input" checked="" name="<?= $mo[0]; ?>-lecture">
                                    <span class="custom-control-label"></span>
                                  </label>
                            </td>
                            <td>
                                  <label class="custom-control custom-checkbox px-2 m-0">
                                    <input type="checkbox" class="custom-control-input"  name="<?= $mo[0]; ?>-ecriture">
                                    <span class="custom-control-label"></span>
                                  </label>
                            </td>
                            <td>
                                  <label class="custom-control custom-checkbox px-2 m-0">
                                    <input type="checkbox" class="custom-control-input"  name="<?= $mo[0]; ?>-execution">
                                    <span class="custom-control-label"></span>
                                  </label>
                            </td>

                            <?php } elseif($mo[1] ==  'ecriture') { ?>
                            ...
                            <td>
                                  <label class="custom-control custom-checkbox px-2 m-0">
                                    <input type="checkbox" class="custom-control-input" checked="" name="<?= $mo[0]; ?>-ecriture">
                                    <span class="custom-control-label"></span>
                                  </label>
                            </td>
                            <td>
                            ...
                            <td>
                                  <label class="custom-control custom-checkbox px-2 m-0">
                                    <input type="checkbox" class="custom-control-input" checked="" name="<?= $mo[0]; ?>-execution">
                                    <span class="custom-control-label"></span>
                                  </label>
                            </td>
                            ...
                            <td>
                                  <label class="custom-control custom-checkbox px-2 m-0">
                                    <input type="checkbox" class="custom-control-input"  name="<?= $mo[0]; ?>-lecture">
                                    <span class="custom-control-label"></span>
                                  </label>
                            </td>
                            <td>
